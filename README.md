...
//TOREJ POTREBEN ADMIN DASHBOARD, MOCK PAYING SYSTEM (ideally API) SEVEDA KAVCIJA NE JAMSTVO, PRILAGODITVE OSTALIM JEZIKOM, EUR & USD BACKEND IN PRILAGOJEN PRIKAZ ZA DRUGE VALUTE (PRESONALIZED CONVERSION RATE), "ARE YOU SURE DA BI SI SPOSODU/ODDOU/SPREJEU ETC." PROMPT SPOSOJO-RENT OUTU AKA. VSE KAR JE IREVERSIBLE RABI BIT 2F POTRJENO
